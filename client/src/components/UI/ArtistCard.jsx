...
export const ArtistCard = ({ imgSrc, name }) => {
    return (
        <div className="card w-32 md:w-40 flex flex-col items-center justify-center md:min-w-[8rem] h-fit group rounded-lg hover:scale-105 transition ease-in-out duration-200 group overflow-hidden shrink-0 p-1">
