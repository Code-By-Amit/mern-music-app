...
export const DarkLightToggleButton = ({toggleDarkMode}) => {
    return (
            <div className="container">
                <label className="toggle" htmlFor="switch"  >
                    <input id="switch" className="input" type="checkbox" onChange={toggleDarkMode}/>
                        <div className="icon icon--moon ">
                            <svg height="30" width="30" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
