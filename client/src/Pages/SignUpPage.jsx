                ...
                <div className="formContainer bg-white p-7 md:p-10  rounded-md shadow-xl m-4">
                    ...
                    <form>
                        ...
                        <div className='flex gap-4 *:w-full'>
                            <input className='bg-gray-100 p-3 rounded' type="text" placeholder='First Name' />
                            <input className='bg-gray-100 p-3 rounded' type="text" placeholder='Last Name' />
                        </div>
                            <input className='bg-gray-100 p-3 rounded' type="text" placeholder='Username' />
                            <input className='bg-gray-100 p-3 rounded' type="text" placeholder='Password' />
                            <input className='bg-gray-100 p-3 rounded' type="text" placeholder='Confirm Password' />
                        </div>
                        <button className='bg-[var(--primary-color)] w-full text-white font-bold py-2 rounded-md mt-13 hover:opacity-85' type='submit'>Sign Up</button>
                    </form>
                </div>
            </div>
        </>
