...
export const Home = () => {
  ...
  <div className="songscards flex max-w-full gap-4 p-4">
  ...
  <div className='playlist flex overflow-y-hidden overflow-x-scroll gap-4 items-center justify-start p-4'>
