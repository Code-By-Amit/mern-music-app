      ...
      <div className=" w-full bg-gray-100 dark:bg-gray-800 p-1.5 overflow-auto">
        ...
        <div className="Songs my-4">
          ...
          <div className='songscards flex  overflow-x-auto flex-nowrap  items-center justify-start gap-4 p-4'>
            <SongCard
              image="https://c.saavncdn.com/527/My-Name-Is-Khan-Hindi-2010-20190617160533-500x500.jpg"
            ...
            />
            <SongCard
              image="https://i.ytimg.com/vi/O8h4GU95aZA/maxresdefault.jpg"
              title='Mitwa'
            />
            <SongCard
              image="https://res.cloudinary.com/dk6waforl/image/upload/v1722673827/apna-bana-le-lyrics_hcp6le.webp"
